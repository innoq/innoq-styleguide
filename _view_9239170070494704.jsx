...
const generateMacro = context => {
  return () => <ValidationWrapper><main role="main">
    <article class="page-layout--grid">
        <header class="center article-intro">
            ...
            <ul class="list-unstyled">
                <li class="author-bio author-bio--short" itemscope itemtype="http://schema.org/Person">
                    <div class="author-bio__image avatar avatar--small">
                        <a class="author-bio__anchor avatar__link" href="#author-bio">
                            <img class="avatar__image" itemprop="photo" src="https://innoq.com/assets/uploads/staff_member/photo/alex/thumb_DSC02016_2.jpg" alt="Portrait von Alexander Hesingfeld" />
                        </a>
                    </div>
                    <div>
                        <div class="author-bio__name" itemprop="name">
                            <a class="author-bio__link" itemprop="url" href="https://innoq.com/de/staff/alexander-heusingfeld/">Alexander Heusingfeld</a>
                        </div>
                ...
                <li class="author-bio author-bio--short" itemscope itemtype="http://schema.org/Person">
                    <div class="author-bio__image avatar avatar--small">
                        <a class="author-bio__anchor avatar__link" href="#author-bio">
                            <img class="avatar__image" itemprop="photo" src="https://innoq.com/assets/uploads/staff_member/photo/otigges/thumb_DSC01893.jpg" alt="Portrait von Alexander Hesingfeld" />
                        </a>
                    </div>
                    <div>
                        <div class="author-bio__name" itemprop="name">
                            <a class="author-bio__link" itemprop="url" href="https://innoq.com/de/staff/alexander-heusingfeld/">Oliver Tigges</a>
                        </div>
        ...
        <section class="center">
            ...
            <pre>{safe(htmlEncode(context.code))}</pre>
            ...
            <blockquote class="superquote">
                ...
                <div itemscope itemtype="http://schema.org/Person">
                    <cite class="superquote__author" itemprop="name">Alexander Heusingfeld</cite>
    ...
    <aside class="page-layout--grid">
        <section class="center">
            <div id="author-bio" class="author-bio author-bio--long" itemscope="" itemtype="http://schema.org/Person">
                <div class="author-bio__image avatar avatar--base">
                  <img itemprop="photo" class="avatar__image" src="https://innoq.com/assets/uploads/staff_member/photo/alex/thumb_DSC02016_2.jpg" alt="Portrait von Alexander Hesingfeld" />
                </div>
                <div class="author-bio__head">
                    <div class="author-bio__name" itemprop="name">
                        <a class="author-bio__link" href="/de/staff/alexander-heusingfeld/">Alexander Heusingfeld</a>
                    </div>
                    <div class="author-bio__info" itemprop="jobTitle" >Senior Consultant</div>
                    <div class="author-bio__social">
                        <i class="icon icon--social icon-twitter"></i>
                        <a class="author-bio__handle" itemprop="url" title="Twitter" href="http://twitter.com/aheusingfeld">
                            aheusingfeld
                        </a>
                    </div>
                </div>
        ...
        <section class="center reference">
            <a href="#" class="reference__link">
                <img class="reference__image" src="https://innoq.com/assets/source_logos/business_technology-0bb5974e53e7ae33adf5c8e2e52a7acc78578788952d581d4c1c8a84aa0aa4be.svg" alt="Business technology" />
            </a>
        ...
        <section class="center share-section">
            ...
            <ul class="share-section__list">
                ...
                <li>
                    <a class="share-section__link" target="_blank" href="http://twitter.com/share?url=https%3A%2F%2Fwww.innoq.com%2Fde%2Farticles%2F2017%2F06%2Finnovation-tokens%2F&amp;text=Innovation+Tokens+%E2%80%93+Gegen+Informatikerromantik+und+Technologie%C3%BCberflutung+von+%40aheusingfeld&amp;via=innoq">
                        <i class="icon icon--social icon-twitter"></i>
                    </a>
                </li>
                <li>
