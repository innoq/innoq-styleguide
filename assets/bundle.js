(() => {
  // components/05-atoms/media/audio-player/audio-player.js
  ...
  // components/05-atoms/togglers/check-to-toggle/check-to-toggle.js
  ...
  // components/05-atoms/togglers/multi-toggler/multi-toggler.js
  ...
  // components/04-molecules/wall-of-consent/wall-of-consent.js
  ...
  // components/03-organisms/navbar/submenu.js
  ...
  // components/03-organisms/navbar/menu-toggle.js
  ...
  // components/04-molecules/slider/touch-detection.js
  ...
  // components/04-molecules/filter/filter.js
  ...
  // components/04-molecules/quotes/quote-carousel/quote-carousel.js
  var QuoteCarousel = class extends HTMLElement {
    connectedCallback() {
    ...
    createControls() {
      ...
      nextBtn.setAttribute("aria-label", "N\xE4chstes Zitat");
